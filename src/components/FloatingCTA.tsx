  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-4 z-50 flex flex-col items-end gap-3">
        {/* Top row: two phone icon buttons side by side */}
        <div className="flex flex-row gap-2">
          {/* Call 1 */}
          <a
            href="tel:+919999109040"
            title="Call 9999109040"
            className="flex items-center justify-center w-12 h-12 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full shadow-lg transition-colors"
        ...
        <a
          ...
          className="flex items-center gap-2 bg-lime-400 hover:bg-lime-500 text-gray-900 font-semibold px-4 py-3 rounded-full shadow-lg transition-colors text-sm"
